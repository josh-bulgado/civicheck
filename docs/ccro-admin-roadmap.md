...
The CCRO Administrator owns the day-to-day delivery of citizen-facing services. This includes requests, staff assignments, the service catalog, walk-in intake, and operational reporting.
...
- Group daily request and departmental intake tasks under Operations.
...
#### 2. Staff and Department Visibility
...
2. Connect request-stage, incomplete-request, and ready-for-release/unpaid metrics to existing application data.
...
4. Prepare representative demo data that exercises the overview, reports, and Request Queue.
...
- [x] Request Queue, Services Registry, Staff management, and Browse Services remain accessible to their permitted roles.
