...
import { MyRequestsPageSkeleton } from "~/features/requests/pages/MyRequestsPageSkeleton";

export const Route = createFileRoute("/_authed/_dashboard/my-requests/")({
  beforeLoad: ({ context }) => {
  ...
  pendingMs: 250,
  pendingMinMs: 250,
  pendingComponent: MyRequestsPageSkeleton,
