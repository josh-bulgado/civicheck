...
interface ServiceApplicationPageProps extends ServiceDetail {
  serviceCode: string;
  /** Called after a successful submission, so the route can invalidate and navigate away. */
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.error) {
        ...
        onSubmitted(res.trackingNumber);
      }
    } catch (err: any) {
